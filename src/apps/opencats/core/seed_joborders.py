...
async def seed_joborders() -> Dict[str, Any]:
            ...
            try:
                ...
                if result and result.get("status_code") == 200:
                    ...
                    if entity_id:
                        ...
                        seeded_joborders.append({
                            "original_data": joborder,
                ...
                logger.error(f"❌ Error seeding job order '{joborder_title}': {str(e)}")
                seeded_joborders.append({
                    "original_data": joborder,
                    "opencats_id": None,
                    "status": "error",
    ...
    return {
        "seeded_joborders": seeded_count,
        "errors": error_count,
        "details": seeded_joborders
    }
