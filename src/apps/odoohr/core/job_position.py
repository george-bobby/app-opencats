"""Creates and manages job positions with requirements."""
...
from apps.odoohr.core.industry import get_industries
from apps.odoohr.core.skill import get_skills
...
async def insert_job_positions():
    ...
    async with OdooClient() as client:
        ...
        industry_map = {i["name"]: i["id"] for i in industries}

        users = await client.search_read("res.users", [("active", "=", True)], ["id"])
