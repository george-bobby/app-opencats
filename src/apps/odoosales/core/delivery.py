...
async def insert_deliveries():
    ...
    # Process deliveries sequentially (single-threaded)
    await _process_delivery_chunk(items_to_process)
    logger.succeed(f"Inserted {len(items_to_process)} deliveries successfully.")
