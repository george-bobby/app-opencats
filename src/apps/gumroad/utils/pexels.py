...
class PexelsAPI:
    ...
    def __init__(
        self,
        api_key: str | None = settings.PEXELS_API_KEY,
        ...
        # Default headers for Pexels API
    ...
    async def search_photos(
        ...
        logger.info(f"Searching Pexels for '{query}' (page {page}, {per_page} per page)")
    ...
    async def get_photo(self, photo_id: int) -> dict[str, Any]:
        ...
        """
        logger.info(f"Getting photo details for ID: {photo_id}")
    ...
    async def get_curated_photos(self, per_page: int = 80, page: int = 1) -> dict[str, Any]:
        ...
        logger.info(f"Getting curated photos (page {page}, {per_page} per page)")
    ...
    async def search_videos(
        ...
        logger.info(f"Searching Pexels videos for '{query}' (page {page}, {per_page} per page)")
    ...
    async def get_popular_videos(
        ...
        logger.info(f"Getting popular videos (page {page}, {per_page} per page)")
    ...
    async def get_collections(self, per_page: int = 15, page: int = 1) -> dict[str, Any]:
        ...
        logger.info(f"Getting collections (page {page}, {per_page} per page)")
    ...
    async def get_collection_media(
        ...
        logger.info(f"Getting media from collection {collection_id} (page {page}, {per_page} per page)")
